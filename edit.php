<div class="container">
	<div class="row mt-4">
		<div class="col">
			<h2 class="text-center">Ubah Hero</h2>
		</div>
	</div>
		...
		<div class="col">
			...
			<?= form_open_multipart(base_url('product/edit/' . $product['id'])) ?>
				...
				<div class="form-group row">
					<label for="name" class="col-sm-2 col-form-label font-weight-bold">Nama Hero</label>
					<div class="col-sm-10">
				...
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Infromasi</label>
					<div class="col-sm-10">
				...
				<div class="form-group row">
					<label class="col-sm-2 col-form-label font-weight-bold">Jenis Hero</label>
					<div class="col-sm-10">
